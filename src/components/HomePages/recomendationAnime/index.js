...
import useRemoteRecomendationAnime from '../../../hooks/remote/useRemoteRecomendationAnime';
import {TouchableRipple} from 'react-native-paper';

const RecomendationAnime = ({navigation}) => {
  const {data: dataRecomendationAnime, isLoading} =
    useRemoteRecomendationAnime();
                      ...
                      <Box
                        ...
                        <Flex justify="flex-end" h="full">
                          <Text
                            ...
                            fontWeight="bold"
                            zIndex={4}>
                            EP {item.episodes ? item.episodes : 'On going'}
                          </Text>
                        </Flex>
                      </Box>
                    </Box>
